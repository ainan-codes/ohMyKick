...
async function run() {
  ...
  console.log('\n======================================');
  console.log('Testing prediction flow goals select and locking');
  console.log('======================================');
  ...
  // Lock it in
  res = await sendMsg(userId, 'lock_it_in', state);
  state = res.sessionState || {};

  console.log('\n======================================');
  console.log('Testing post-prediction keywords: stats, nations, profile, passport');
  console.log('======================================');
  ...
  // Send "passport"
  res = await sendMsg(userId, 'passport', state);
  state = res.sessionState || {};
}
